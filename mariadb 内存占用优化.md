[mariadb 内存占用优化](https://www.cnblogs.com/qcloud1001/p/10308159.html)
====================================================================
...
如果应用中，很少出现join语句，则可以不用太在乎join\_buffer\_size参数的设置大小。
...
max\_heap\_table\_size 用户可以创建的内存表(memory table)的大小.这个值用来计算内存表的最大行数值。
